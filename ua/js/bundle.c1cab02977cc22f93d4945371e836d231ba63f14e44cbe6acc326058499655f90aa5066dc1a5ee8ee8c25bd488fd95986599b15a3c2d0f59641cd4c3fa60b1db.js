...
const baseURL = 'https://techworld-with-yevgen.com/blog/';
...
const shortSearchQuery = 'Запит занадто короткий'
const typeToSearch = 'Введіть для пошуку';
const noMatchesFound = 'Нічого не знайдено';
